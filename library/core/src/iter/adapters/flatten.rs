    ...
    U: Iterator,
{
    ...
    ///
    /// Used by `advance_by` and `try_fold`.
    #[inline]
    ...
    U: DoubleEndedIterator,
{
    ...
    ///
    /// Used by `advance_back_by` and `try_rfold`.
    #[inline]
    ...
    U: Iterator,
{
    ...
    fn advance_by(&mut self, n: usize) -> Result<(), usize> {
        #[inline]
        fn advance<I: Iterator>(n: usize, iter: &mut I) -> ControlFlow<usize, ()> {
            match iter.advance_by(n) {
                Ok(()) => ControlFlow::BREAK,
                Err(k) => ControlFlow::Continue(n - k),
            }
        }

        match self.iter_try_fold(n, advance) {
            ControlFlow::Continue(rem) => Err(n - rem),
    ...
    U: DoubleEndedIterator,
{
    ...
    fn advance_back_by(&mut self, n: usize) -> Result<(), usize> {
        #[inline]
        fn advance<I: DoubleEndedIterator>(n: usize, iter: &mut I) -> ControlFlow<usize, ()> {
